...
Voiceover note: "做视觉产品时，我不想每次都凭感觉说'变好看了'。这个命令会自动点 D1-D4、截图、检查 WebGL 像素和微动，还会写 summary.json。这样每次 Vibe Coding 迭代都有证据可以复盘。"
